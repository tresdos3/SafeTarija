...
import com.tarija.tresdos.safetarija.other.contact;
    ...
    private void cargar() {
        ...
        HijosRef.child("hijos").child(texto).child("contactos").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Adapter adapter = new Adapter(ContactosMainActivity.this);
                ListaView.setAdapter(adapter);
            }

            @Override
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(ContactosMainActivity.this, "Error al conectar base de datos", Toast.LENGTH_SHORT).show();
            }
        });
    }
    class Adapter extends BaseAdapter {
        ...
        public View getView(final int i, View view, ViewGroup viewGroup) {
            ...
            if (view == null) {
                ...
                view = layoutInflater.inflate(R.layout.itemcontacto, viewGroup, false);
...
//                    Toast.makeText(ContactosLLActivity.this, "Llamando: "+ numeros.get(i), Toast.LENGTH_SHORT).show();
                    ...
                    if (ActivityCompat.checkSelfPermission(ContactosMainActivity.this, android.Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                        return;
                    }
